...
import com.autonavi.auto.skin.view.SkinListView;
import com.desaysv.psmap.model.R;

public class PullToRefreshListView extends SkinListView implements AbsListView.OnScrollListener {
    ...
    private void initWithContext(Context context) {
        ...
        mHeaderTipsView = (TextView) mHeaderView
                .findViewById(R.id.head_tipsTextView);
        addHeaderView(mHeaderView);

        // init footer view
        mFooterView = new ListViewFooter(context);
        mFooterTipsView = mFooterView.findViewById(R.id.footer_tips);
        // init header height
...
//			mFooterView.show();
    ...
    public void setRefreshTips(String tips) {
        mHeaderView.setTips(tips);
        mHeaderTipsView.setText(tips);
    }
     ...
     * @param color
     */
    public void setRefreshTipsTextColor(int color) {
        mHeaderView.setTextColor(color);
        mHeaderTipsView.setTextColor(color);
    }

    public void setLoadMoreTips(String tips) {
        mFooterTipsView.setText(tips);
        mFooterView.setTips(tips);
    }
     ...
     * @param color
     */
    public void setLoadMoreTipsTextColor(int color) {
        mFooterTipsView.setTextColor(color);
        mFooterView.setTextColor(color);
    }
...
//		setSelection(mTotalItemCount - 1); // scroll to bottom
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (getFirstVisiblePosition() == 0
                        && (mHeaderView.getVisiableHeight() > 0 || deltaY > 0) && scrollEnable) {
                    // the first item is showing, header has shown or pull down.
                    updateHeaderHeight(deltaY / OFFSET_RADIO);
                    invokeOnScrolling();
                } else if (getLastVisiblePosition() == mTotalItemCount - 1
                        && (mFooterView.getBottomMargin() > 0 || deltaY < 0) && scrollEnable) {
    ...
    public void setRefreshAndLoadTextColors(int colors) {
        mHeaderView.setTextColors(colors);
        mFooterView.setTextColors(colors);
    }
}
