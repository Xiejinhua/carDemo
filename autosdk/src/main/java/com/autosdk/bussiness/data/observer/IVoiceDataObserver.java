 ...
 **/
public interface IVoiceDataObserver extends IDownloadObserver, IDataInitObserver, IDataListObserver, IImageObserver {
    /**
    ...
    @Override
    void onDownloadImage (int itemId,  int opErrCode, String strFilePath, @DataType.DataType1 int dataType);
