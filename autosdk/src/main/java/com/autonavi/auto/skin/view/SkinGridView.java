...
import com.autonavi.auto.common.view.GridViewWithHeaderAndFooter;
 ...
 * Created by AutoSdk.
 */
public class SkinGridView extends GridViewWithHeaderAndFooter implements ISkin, ISkin.IViewSkin, IShadowView {
    ...
    public SkinGridView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void addFooterView(View v) {
        ...
        SkinManager.getInstance().updateView(v, NightModeGlobal.isNightMode(), true);
    }
