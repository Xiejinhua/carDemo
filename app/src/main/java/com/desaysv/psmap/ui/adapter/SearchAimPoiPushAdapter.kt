...
import com.desaysv.psmap.databinding.ItemSearchAimPoiPushBinding
...
class SearchAimPoiPushAdapter(
    private var selectPosition: Int = -1, //选中的item，默认0
) : BaseQuickAdapter<SearchResultBean, BaseDataBindingHolder<ItemSearchAimPoiPushBinding>>(R.layout.item_search_aim_poi_push) {
    ...
    override fun convert(
        holder: BaseDataBindingHolder<ItemSearchAimPoiPushBinding>,
