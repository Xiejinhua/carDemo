...
import com.desaysv.psmap.databinding.LayoutIcpPopBinding
 ...
 */
@Singleton
class IcpPopWindow @Inject constructor(
    private val application: Application,
    private val skyBoxBusiness: SkyBoxBusiness,
    private val settingAccountBusiness: SettingAccountBusiness
) {
    private var binding: LayoutIcpPopBinding? = null
    private var windowManager: WindowManager? = null

    private fun showIcpPop(moreInfo: MoreInfoBean, gravity: Int, ySet: Int) {
        cancelIcpPop()
        ...
        if (binding == null) {
            binding = LayoutIcpPopBinding.inflate(LayoutInflater.from(displayContext))
        }
    ...
    fun showIcpPop(moreInfo: MoreInfoBean, gravity: Int) {
        showIcpPop(moreInfo, gravity, application.resources.getDimensionPixelSize(com.desaysv.psmap.base.R.dimen.sv_dimen_0))
    }

    fun showIcpPop(moreInfo: MoreInfoBean) {
        showIcpPop(moreInfo, Gravity.CENTER)
    }
}